    ...
    if (this.state.liked) {
      return (
        <button className="unlike-button" onClick={this.onUnlikeClick}>
          <svg className="animated bounceIn" version="1.1" id="Capa_1" x="0px" y="0px" width="33.8551px" height="39.1818px" viewBox="-0.518 0 50.5 60.68" enable-background="new -0.518 0 50.5 60.68">
            <path fill="#EE4266" stroke="#EE4266" strokeWidth="0.5" stroke-miterlimit="10" d="M4.307,2.671c3.1-3,14.5-0.5,14.5-0.5
      ...
      return (
        <button className="like-button" onClick={this.onLikeClick}>
          <svg version="1.1" id="Capa_1" x="0px" y="0px" width="33.8551px" height="39.1818px" viewBox="0 0 54.25 64.25" enable-background="new 0 0 54.25 64.25">
            <path fill="#FFFFFF" stroke="#EE4266" strokeWidth="4" stroke-miterlimit="10" d="M6.75,4.351c3.1-3,14.5-0.5,14.5-0.5
