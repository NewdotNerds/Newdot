    ...
    if (this.state.liked) {
      return (
        <button className="unlike-button" onClick={this.onUnlikeClick}>
          <svg className="animated bounceIn" version="1.1" id="Capa_1" x="0px" y="0px" width="13.8551px" height="19.1818px" viewBox="-0.518 0 50.5 60.68" enable-background="new -0.518 0 50.5 60.68">
      ...
      return (
        <button className="like-button" onClick={this.onLikeClick}>
          <svg version="1.1" id="Capa_1" x="0px" y="0px" width="13.8551px" height="19.1818px" viewBox="0 0 54.25 64.25" enable-background="new 0 0 54.25 64.25">
